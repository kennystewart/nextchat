...
const HighRollerCard = () => {
  return (
    <div className="border-1 border-2 items-center border-gray-300 p-6 rounded my-8 md:mx-80 md:p-12 md:rounded-xl md:flex md:justify-between">
      ...
      <div className="flex items-center justify-between py-4 md:flex-col">
        ...
        <div className="flex flex-col">
          <div className="flex items-center">
            <p className="text-lg font-medium pr-3 md:flex flex-col md:text-4xl">320% <span className='md:text-lg'>up to $3,200</span></p>            
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between py-4 md:flex-col">
        ...
        <div className="flex flex-col">
          <div className="flex items-center">
          <p className="text-lg font-medium pr-3 md:flex flex-col md:text-4xl">25 <span className='md:text-lg'>Free Spins</span></p>            
          </div>
        </div>
      </div>
      <hr className='border-sky-700 dark:border-white' />
