...
-- CreateIndex
CREATE UNIQUE INDEX "_usersInChat_AB_unique" ON "_usersInChat"("A", "B");
...
-- AddForeignKey
ALTER TABLE "_usersInChat" ADD CONSTRAINT "_usersInChat_B_fkey" FOREIGN KEY ("B") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
