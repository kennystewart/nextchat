  ...
  return (
    <div>
      ...
      <div className="flex md:hidden justify-between bg-sky-700 px-4 py-2 items-center text-white dark:bg-white dark:text-black">
        ...
        <div className={`flex md:hidden flex-col w-full fixed p-4 rounded-t-2xl justify-between z-20 bg-white  text-2xl font-medium ${show ? 'bottom-[-490px]' : 'bottom-0'}`}>
          <div className='flex justify-between w-full items-center'>
            <div>ON THIS PAGE</div>
            <div onClick={()=>setShow(!show)} className=""><GrClose className='' /></div>
          </div>
          <hr className='border-1 my-4 border-sky-700' />
          <div className='flex flex-col font-normal text-lg space-x-2 space-y-4'>
            <span className='font-medium border-l-2 px-4 border-sky-700'>Our top picks</span>
        ...
        <div className="hidden md:w-1/4 md:flex md:flex-col dark:bg-black md:">
