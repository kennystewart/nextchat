              ...
              <div className="bg-sky-700 p-4 text-white dark:bg-white dark:text-black rounded-b-lg">
                ...
                <div className="flex-flex-col">
                  <div className="flex my-6">
                    <div className="flex flex-col">
                      <button className="mx-2 mt-2 w-7 h-7 font-bold rounded-full bg-white dark:bg-black dark:text-white">
                        1
                      </button>
                      <button className="my-10 mx-2 w-7 h-7 font-bold rounded-full bg-white text-sky-700 dark:bg-black dark:text-white md:my-14">
                        2
                      </button>
                      <button className="mx-2 mr-4 mt-2 w-7 h-7 font-bold rounded-full bg-white text-sky-700 dark:bg-black dark:text-white md:mt-0">
                        3
                      </button>
                    </div>
                    <div className="flex flex-col">
