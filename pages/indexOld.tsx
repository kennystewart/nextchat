...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Casinos</title>
        <meta name="description" content="Allfreechips online casino bonus review and promotional site." />
        <meta name="ahrefs-site-verification" content="bd22a5aaa12fd898b2e922db09fdb934f6920c0e183fe66cba2fc18ac46413b9" />
      ...
      <div className="bg-white text-sky-700 dark:bg-zinc-800 dark:text-white">
        ...
        <div className="text-left p-4 md:container mx-auto">
          ...
          <p className="text-base font-medium my-6 text-justify  md:text-2xl">
            How about trying your hand at microgaming, playing some slot
            machine, or completing a Royal Flush without making any casino
            deposits? If any of these activities appeal to you, Allfreechips is
            the place you need. We are the source of unlimited bonuses and
            casino codes for cash, free spins, deposit related offers, and more.
            With our promotional opportunities, all gambling enthusiasts can
            make use of a myriad of extra perks while bringing their gaming
          ...
          <p className="text-base font-medium my-6 text-justify md:text-2xl">
            ...
            choose between hundreds of platforms to play with. If it is your
            case, it s time to leave all those worries to Allfreechips! We will
        ...
        <div className="text-left p-4 mt-2 md:mx-24 md:text-2xl">
          ...
          <p className="text-base font-medium my-6 text-justify md:text-2xl md:font-normal">
            Whether you re a fan of slot machines or feel passionate about
            joining RTG casinos, you will be able to get the most out of your
            gambling activity with casino bonus codes provided by Allfreechips.
            Using our online casino guide is the best way of trying out a site
            risk free. You do not have to make any deposits to test the gambling
            services and find out whether the casino is the one you want to deal
            with.
          </p>
        </div>
        ...
        <div className="text-left p-4 md:mx-24">
          ...
          <div className="flex flex-col md:flex-row">
            <div className="pr-10">
              <p className="text-base font-medium my-6 text-justify md:text-2xl md:font-normal">
                ...
                latest online casino offers and news so that you are always in
                the right place at the right time. What is more, our forum will
                provide you with the useful information like upcoming contests
                and freeroll passwords.
              </p>
              <p className="text-base font-medium my-6 text-justify md:text-2xl md:font-normal">
                Count on Allfreechips and take advantage of every promotional
                opportunity! We will enable you to gamble in the way you want
                to.
              </p>
              <p className="text-base font-medium my-6 text-justify md:text-2xl md:font-normal">
                Currently we are pushing to find the best online casino for the
                USA! is the best casino going to be from RTG or Saucify we do
                not know but you can help us. Simple find your best casino and
                submit a review, in going so you can help others decide where to
                play and get some AFC reward points to boot!
              </p>
            </div>
              ...
              <div className="bg-sky-700 p-4 text-white dark:bg-white dark:text-black rounded-b-lg">
                ...
                <div className="flex-flex-col">
                  <div className="flex my-6">
                    <div className="flex flex-col">
                      <button className="mx-2 mt-2 w-7 h-7 font-bold rounded-full bg-white dark:bg-zinc-800 dark:text-white">
                        1
                      </button>
